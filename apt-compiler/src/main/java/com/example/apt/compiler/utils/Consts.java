...
public class Consts {
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.example.apt.routes";
    public static final String PACKAGE_OF_GENERATE_DOCS = "com.example.apt.docs";
    ...
    // Custom interface
    private static final String FACADE_PACKAGE = "com.example.apt.facade";
