 ...
 */
class ScanSetting {
    static final String PLUGIN_NAME = "com.example.apt"
    /**
     * The register code is generated into this class
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/example/apt/core/LogisticsCenter'
    /**
     ...
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/example/apt/routes/'
    /**
     * The package name of the interfaces
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/example/apt/facade/template/'
